...
export libcufft, libdevice, libnppist, libcublas, libcudadevrt, libnppial, libnppicc, libcusparse, libnppim, libnpps, libcusolver, libnppicom, libnppidei, nvdisasm, libnppig, libnppisu, libnvtoolsext, libcurand, libcudart, libcupti, libcufftw, libnvblas, libnppitc, libnppc, libnvvm, libcublasLt, libcurand, libnppif
...
const libcupti_splitpath = ["bin", "cupti64_101.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libcupti = "cupti64_101.dll"
