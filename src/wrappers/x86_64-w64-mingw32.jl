...
const libnppitc_splitpath = ["bin", "nppitc64_92.dll"]
...
const libnppitc = "nppitc64_92.dll"


# Relative path to `libnppisu`
const libnppisu_splitpath = ["bin", "nppisu64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libnppisu = "nppisu64_92.dll"


# Relative path to `libnppidei`
const libnppidei_splitpath = ["bin", "nppidei64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libnppidei = "nppidei64_92.dll"


# Relative path to `libnvblas`
const libnvblas_splitpath = ["bin", "nvblas64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libnvblas = "nvblas64_92.dll"


# Relative path to `libnppist`
const libnppist_splitpath = ["bin", "nppist64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libnppist = "nppist64_92.dll"
...
const libcurand_splitpath = ["bin", "nvgraph64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libcurand = "nvgraph64_92.dll"


# Relative path to `libcurand`
const libcurand_splitpath = ["bin", "curand64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libcurand = "curand64_92.dll"


# Relative path to `libnpps`
const libnpps_splitpath = ["bin", "npps64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libnpps = "npps64_92.dll"


# Relative path to `libnppicom`
const libnppicom_splitpath = ["bin", "nppicom64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libnppicom = "nppicom64_92.dll"


# Relative path to `libcusparse`
const libcusparse_splitpath = ["bin", "cusparse64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libcusparse = "cusparse64_92.dll"


# Relative path to `libnppicc`
const libnppicc_splitpath = ["bin", "nppicc64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libnppicc = "nppicc64_92.dll"


# Relative path to `libcusolver`
const libcusolver_splitpath = ["bin", "cusolver64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libcusolver = "cusolver64_92.dll"
...
const libnppif_splitpath = ["bin", "nppif64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libnppif = "nppif64_92.dll"


# Relative path to `libnppim`
const libnppim_splitpath = ["bin", "nppim64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libnppim = "nppim64_92.dll"


# Relative path to `libcudart`
const libcudart_splitpath = ["bin", "cudart64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libcudart = "cudart64_92.dll"


# Relative path to `libnppc`
const libnppc_splitpath = ["bin", "nppc64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libnppc = "nppc64_92.dll"


# Relative path to `libcufftw`
const libcufftw_splitpath = ["bin", "cufftw64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libcufftw = "cufftw64_92.dll"


# Relative path to `libcufft`
const libcufft_splitpath = ["bin", "cufft64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libcufft = "cufft64_92.dll"


# Relative path to `libnppial`
const libnppial_splitpath = ["bin", "nppial64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libnppial = "nppial64_92.dll"


# Relative path to `libnppig`
const libnppig_splitpath = ["bin", "nppig64_92.dll"]
...
const libcupti_splitpath = ["bin", "cupti64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libcupti = "cupti64_92.dll"


# Relative path to `libnvvm`
const libnvvm_splitpath = ["bin", "nvvm64_32_0.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libnvvm = "nvvm64_32_0.dll"


# Relative path to `libcublas`
const libcublas_splitpath = ["bin", "cublas64_92.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libcublas = "cublas64_92.dll"
